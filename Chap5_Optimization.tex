...
a uma taxa de $R_b =$ 1.83 Gb/s e 40 km de fibra SSMF sem compensação óptica da
dispersão cromática.
...
$B_G$ não necessariamente deveria seguir esta igualdade. Sendo assim, qual o
valor de banda de guarda deve ser atribuída em aplicações em que sinais OFDM são
...
redução de 20\% $(B_G = 0.8 B_W)$ na banda de guarda.
