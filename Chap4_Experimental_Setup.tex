...
\subsection{Dispositivo Amplificador e Filtro Passa-Baixas}
Com os objetivos de amplificar o sinal proveniente do conversor D/A e de
eliminar as repetições por \textit{aliasing} proporcionais à taxa de amostragem, usou-se
o dispositivo ZX60-33LN+. Dentre suas
características, as que se destacam são sua largura de banda de operação
que varia entre $50$ e $3000$ MHz, uma baixa figura de ruído de $1.1$ dB e
potência de saída máxima igual a $17.5$ dBm. As Figuras \ref{Fig:LPF_image} e
\ref{Fig:LPF_curve} ilustram respectivamente, o dispositivo e a curva de
ganho da sua resposta em frequência para alimentações com $3$ e
$5$ V.
