...
elétrico do sinal deslocado para $f'_c$ agora com uma menor frequência máxima do
sinal ${B'}_c$. Outra abordagem que existe em sistemas ópticos OFDM está
relacionados à inserção do prefíxo cíclico no início de cada sinal transmitido.
...
eliminando-o, em virtude de possuir um sinal cíclico viabilizando o uso da
convolução circular \cite{Book:DSP_Mitra}. A Figura \ref{Fig:Graph_Ig-a} mostra
curvas para uma dada distância, valores de tempo de símbolo versus tempo de
guarda. A Figura \ref{Fig:Graph_Ig-b} demonstra a influência do intervalo de
guarda na qualidade da recepção do sinal OFDM.
