...
convolução circular \cite{Book:DSP_Mitra}. A Figura \ref{Fig:Graph_Ig}
...
alcançar uma determinada BER \cite{Kaminow_Book}. A relação sinal ruído óptica
(\textit{Optical Signal-Noise-Ratio} - OSNR) é definida como
\begin{equation}
